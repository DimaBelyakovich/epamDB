...
COMMENT ON COLUMN EVENT_RESULT.POLE_POSITION_ID IS 'Name of driver that take pole position';
COMMENT ON COLUMN EVENT_RESULT.WINNER_ID IS 'Name of driver that won';